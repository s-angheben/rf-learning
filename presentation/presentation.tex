...
\begin{frame}{\makebox[0.95\linewidth][l]{Libraries \hfill \textcolor{lightgray}{\insertsection}}}
\begin{itemize}
...
\begin{frame}{\makebox[0.95\linewidth][l]{Pseudocode \hfill \textcolor{lightgray}{\insertsection}}}
    \begin{textblock*}{\paperwidth}(0mm,30mm) % Position at (0,0)
...
\begin{frame}{\makebox[0.95\linewidth][l]{Table \hfill \insertsection}}
    \begin{table}
        \begin{tabular}{l l l}
            \toprule
